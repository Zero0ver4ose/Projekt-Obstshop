...
function produkteAnbieten(bestand:any) {
...
function auswahlDesProdukts(bestand:any) {
...
function anzahlStueck(objektProdukt:any) {
...
function updateWarenkorb(bestand:any,objektProdukt:any,stueckzahl:number) {
    for (let i in bestand) {
...
function updateBestand(obst:string, Anzahl:number) {
...
function bestandDarstellen(bestand:any) {
    console.log('Bestand: ')
    for (let i in bestand) {

...
function Apfel() {
    ...
    let zahl = parseFloat(document.getElementById("zahl1").value);
    let warenkorb = "";
    for (let i in bestand5) {
...
function Banane() {
    ...
    let zahl = parseFloat(document.getElementById("zahl2").value);
    let warenkorb = "";
    for (let i in bestand5) {
...
function Aprikose() {
    ...
    let zahl = parseFloat(document.getElementById("zahl3").value);
    let warenkorb = "";
    for (let i in bestand5) {
...
function Birne() {
    ...
    let zahl = parseFloat(document.getElementById("zahl4").value);
    let warenkorb = "";
    for (let i in bestand5) {
